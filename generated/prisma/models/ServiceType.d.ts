...
export type GetServiceTypeAggregateType<T extends ServiceTypeAggregateArgs> = {
    [P in keyof T & keyof AggregateServiceType]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateServiceType[P]> : Prisma.GetScalarType<T[P], AggregateServiceType[P]>;
};
...
type GetServiceTypeGroupByPayload<T extends ServiceTypeGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ServiceTypeGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ServiceTypeGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ServiceTypeGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ServiceTypeGroupByOutputType[P]>;
}>>;
export type ServiceTypeWhereInput = {
    ...
    id?: Prisma.IntFilter<"ServiceType"> | number;
    Type?: Prisma.StringFilter<"ServiceType"> | string;
...
export type ServiceTypeScalarWhereWithAggregatesInput = {
    ...
    id?: Prisma.IntWithAggregatesFilter<"ServiceType"> | number;
    Type?: Prisma.StringWithAggregatesFilter<"ServiceType"> | string;
...
export type ServiceTypeOrderByRelevanceInput = {
    fields: Prisma.ServiceTypeOrderByRelevanceFieldEnum | Prisma.ServiceTypeOrderByRelevanceFieldEnum[];
...
export type ServiceTypeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "Type" | "deletedAt" | "createdAt" | "updatedAt", ExtArgs["result"]["serviceType"]>;
...
export type ServiceTypeCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ServiceTypeFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ServiceTypeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends ServiceTypeCountArgs>(args?: Prisma.Subset<T, ServiceTypeCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ServiceTypeCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ServiceTypeGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ServiceTypeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetServiceTypeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface ServiceTypeFieldRefs {
    readonly id: Prisma.FieldRef<"ServiceType", 'Int'>;
    readonly Type: Prisma.FieldRef<"ServiceType", 'String'>;
