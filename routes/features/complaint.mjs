...
import { create, deleteData, getAll, getById, getForCustomer, update, } from "../../controller/features/complaint.mjs";
import upload from "../../middleware/file-upload.mjs";
const complaintRoute = Router();
// get all
complaintRoute.get("/all", async (req, res) => {
...
// get by id
complaintRoute.get("/:id", async (req, res) => {
...
// get for client
complaintRoute.get("/customer/:clientId", async (req, res) => {
...
// create
complaintRoute.post("/", async (req, res) => {
...
// update
complaintRoute.put("/:id", async (req, res) => {
...
// complaint image
complaintRoute.post("/complaint-image", (req, res) => {
    upload.single("complaint-image")(req, res, (err) => {
...
// delete
complaintRoute.delete("/:id", async (req, res) => {
...
//# sourceMappingURL=complaint.mjs.map